#!/usr/bin/env python3
"""
Final production HTTP server for AI Economic News Agent
Serves static HTML and provides API endpoints for articles
Features working links to relevant AI economic content
"""
...
# Sample AI-focused economic news articles with verified working links to relevant content
SAMPLE_ARTICLES = [
    {
        'id': 'ai-econ-1',
